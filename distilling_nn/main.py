...
def dev_distil_model_joint(full_model, small_model, val_iter, full_model_args, small_model_args):
    ...
    for batch in val_iter:
        ...
        small_model_loss1 = softmax_cross_entropy_loss(self_softmax(small_model_logits, small_temperature),
                                                       small_target)
        small_model_loss2 = softmax_cross_entropy_loss(self_softmax(small_model_logits, small_temperature),
                                                       full_model_logits)
        small_model_loss = small_model_loss1 + small_model_loss2
